		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsmoduxtodolist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmoduxtodolist-display": {
								"semanticObject": "comsmoduxtodolist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smod.ux.todolist",
									"url": sap.ui.require.toUrl("com/smod/ux/todolist")
								}
							}
						}
					}
